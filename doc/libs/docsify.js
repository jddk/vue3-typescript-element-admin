...
!(function() {
  function s(n) {
    ...
    return function(e) {
      const t = c(e) ? e : JSON.stringify(e);
      return r[t] || (r[t] = n(e));
    };
  }
  const o = s(function(e) {
    ...
    d =
      Object.assign ||
      function(e) {
        for (let t = arguments, n = 1; n < arguments.length; n++) {
          const r = Object(t[n]);
          for (const i in r) l.call(r, i) && (e[i] = r[i]);
        }
        return e;
      };
  function c(e) {
  ...
  function v(e, t) {
    if ((void 0 === t && (t = !1), "string" == typeof e)) {
      if (void 0 !== window.Vue) return x(e);
      e = t ? x(e) : n[e] || (n[e] = x(e));
    }
    return e;
  }
        ...
        u = (function() {
          var l = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            P = (c.Prism = {
              ...
              util: {
                ...
                clone: function(e, n) {
                  const t = P.util.type(e);
                  switch (((n = n || {}), t)) {
                    case "Object":
                      if (n[P.util.objId(e)]) return n[P.util.objId(e)];
                      var r = {};
                      for (const i in ((n[P.util.objId(e)] = r), e))
              ...
              languages: {
                extend: function(e, t) {
                  const n = P.util.clone(P.languages[e]);
                  for (const r in t) n[r] = t[r];
                  return n;
                },
                insertBefore: function(n, e, t, r) {
                  const i = (r = r || P.languages)[n];
                  ...
                  if (n.hasOwnProperty(l) && n[l]) {
                    ...
                    for (let u = 0; u < c.length; ++u) {
                      ...
                      if (g && !p.pattern.global) {
                        const v = p.pattern.toString().match(/[imuy]*$/)[0];
                      ...
                      for (
                        ...
                        if (!(k instanceof s)) {
                          if (g && b != t.length - 1) {
                            ...
                            for (
                              var x = C.index + (d ? C[1].length : 0),
                                w = C.index + C[0].length,
                                _ = b,
                                S = y,
                                A = t.length;
                              _ < A &&
                              (S < w || (!t[_].type && !t[_ - 1].greedy));
                              ++_
                            )
                              (S += t[_].length) <= x && (++b, (y = S));
                          ...
                          if (C) {
                            ...
                            w = (x = C.index + f) + (C = C[0].slice(f)).length;
                            const $ = k.slice(0, x),
                              L = k.slice(w),
                              T = [b, E];
                            $ && (++b, (y += $.length), T.push($));
          ...
          if (
            ((o.stringify = function(t, n, e) {
              ...
              if (t.alias) {
                const i =
                  "Array" === P.util.type(t.alias) ? t.alias : [t.alias];
  ...
  (ie.prototype.compileEmbed = function(e, t) {
    let n,
      r = ne(t),
      i = r.str,
      a = r.config;
    if (((t = i), a.include)) {
      let o;
      if (
        (X(e) || (e = K(this.contentBase, Q(this.router.getCurrentPath()), e)),
        a.type && (o = re[a.type]))
      )
        ...
        /\.(md|markdown)/.test(e)
          ...
          ? (s = "video")
          : /\.mp3/.test(e) && (s = "audio"),
          ((n = re[s].call(this, e, t)).type = s);
      }
      return (n.fragment = a.fragment), n;
    }
  }),
    (ie.prototype._matchNotCompileLink = function(e) {
      for (let t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
        const r = t[n];
        if ((te[r] || (te[r] = new RegExp("^" + r + "$"))).test(e)) return e;
      }
    }),
    (ie.prototype._initRenderer = function() {
      const e = new M.Renderer(),
        s = this.linkTarget,
        u = this.router,
        p = this.contentBase,
        l = this,
      ...
      return (
        ...
        (t.image = e.image = function(e, t, n) {
          ...
          return (
            X(e) || (r = K(p, Q(u.getCurrentPath()), e)),
            '<img src="' +
              r +
              '"data-origin="' +
              e +
        ...
        (t.listitem = e.listitem = function(e) {
    ...
    (ie.prototype.sidebar = function(e, t) {
      let n = this.toc,
      ...
      if (e) i = this.compile(e);
        ...
        for (let a = 0; a < n.length; a++)
          if (n[a].ignoreSubHeading) {
            const o = n[a].level;
            n.splice(a, 1);
            for (let s = a; o < n[s].level && s < n.length; s++)
              n.splice(s, 1) && s-- && a++;
            a--;
          }
        const l = this.cacheTree[r] || q(n, t);
        (i = R(l, "<ul>{inner}</ul>")), (this.cacheTree[r] = l);
      }
      return i;
    }),
    (ie.prototype.subSidebar = function(e) {
      if (e) {
        const t = this.router.getCurrentPath(),
          n = this.cacheTree,
          r = this.toc;
    ...
    (ie.prototype.article = function(e) {
      return this.compile(e);
    }),
    (ie.prototype.cover = function(e) {
      const t = this.toc.slice(),
        n = this.compile(e);
      return (this.toc = t.slice()), n;
    });
  const ae = b.title;
  function oe() {
    const e = v("section.cover");
    if (e) {
  ...
  function se(e, t, r, n) {
    ...
    return (
      ...
      n && (b.title = a ? a.title || a.innerText + " - " + ae : ae),
      a
    );
  }
  const le = (function() {
  ...
  function fe(e) {
    if (de) {
      ...
      if (t) {
        const p = ue[me(decodeURIComponent(e), t.getAttribute("data-id"))];
        if (
          p &&
          p !== a &&
          ...
          (a = p),
          !pe && y.classList.contains("sticky"))
        ) {
    ...
    if (t) {
      ...
      r &&
        ...
        (he = new ce({
          ...
          .begin()));
      const i = ue[me(e, t)],
        a = x(v(".sidebar"), "li.active");
      a && a.classList.remove("active"), i && i.classList.add("active");
    }
  }
  const be = b.scrollingElement || b.documentElement;
  const ye = {};
  function ke(e, i) {
    let o = e.compiler,
      a = e.raw;
      ...
      for (; (t = n[s++]); ) {
        const r = (function(i) {
          return function(e) {
            let t;
            if (e)
              if ("markdown" === i.embed.type) t = o.lexer(e);
              else if ("code" === i.embed.type) {
                if (i.embed.fragment) {
                  const n = i.embed.fragment,
                    r = new RegExp(
                      "(?:###|\\/\\/\\/)\\s*\\[" +
                        n +
                        "\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[" +
            ...
            a({ token: i, embedToken: t }), ++l >= s && a({});
          };
        })(t);
        t.embed.url ? F(t.embed.url).then(r) : r(t.embed.html);
      }
    })({ compile: s, embedTokens: c, fetch: t }, function(e) {
      const t = e.embedToken,
        n = e.token;
      if (n) {
        const r = n.index + h;
        d(p, t.links),
          ...
          (h += t.length - 1);
      } else (ye[a] = l.concat()), (l.links = ye[a].links = p), i(l);
    });
  }
  function xe() {
    const e = w(".markdown-section>script").filter(function(e) {
  ...
  function _e(e) {
    e || (e = "<h1>404 - Not found</h1>"),
      ...
      !1 === this.config.executeScript || void 0 === window.Vue || xe()
        ? this.config.executeScript && xe()
        : setTimeout(function(e) {
            const t = window.__EXECUTE_RESULT__;
  ...
  function Se(e) {
    ...
    if (c) {
      if (
        ...
        const h = /^data:image/.test(t.logo),
          d = /(?:http[s]?:)?\/\//.test(t.logo),
          g = /^\./.test(t.logo);
        h || d || g || (t.logo = K(e.router.getBasePath(), t.logo));
      }
      (u +=
        ((r =
      ...
      t.themeColor &&
        ...
        (function(n) {
          if (
            ...
            const e = w("style:not(.inserted),link");
            [].forEach.call(e, function(e) {
              if ("STYLE" === e.nodeName) j(e, n);
              else if ("LINK" === e.nodeName) {
                const t = e.getAttribute("href");
                if (!/\.css$/.test(t)) return;
                F(t).then(function(e) {
                  const t = _("style", e);
                  k.appendChild(t), j(t, n);
                });
              }
            });
          }
  ...
  (Ce.prototype.getBasePath = function() {
    ...
    (Ce.prototype.getFile = function(e, t) {
      ...
      return (
        (e = i.alias
          ? (function e(t, n, r) {
              const i = Object.keys(n).filter(function(e) {
                return (
                  (Ae[e] || (Ae[e] = new RegExp("^" + e + "$"))).test(t) &&
                  t !== r
                );
              })[0];
              return i ? e(t.replace(Ae[i], n[i]), n, t) : t;
            })(e, i.alias)
          : e),
        (n = e),
        (r = o),
    ...
    (Ce.prototype.toURL = function(e, t, n) {
      ...
      if (this.config.relativePath && 0 !== e.indexOf("/")) {
        const o = n.substring(0, n.lastIndexOf("/") + 1);
        return V(J(o + e));
      }
      return V("/" + e);
    });
  const $e = (function(r) {
      ...
      return (
        ...
        (e.prototype.normalize = function() {
          ...
          if ("/" === (e = ee(e)).charAt(0)) return Ee(e);
          Ee("/" + e);
        }),
  ...
  function Pe(e) {
    ...
    (t = "button.sidebar-toggle"),
      ...
      e.config.coverpage ? !m && C("scroll", oe) : y.classList.add("sticky");
  }
  function Oe(t, n, r, i, a, e) {
    (t = e ? t : t.replace(/\/$/, "")),
      (t = Q(t)) &&
  ...
  (He._init = function() {
    ...
    (a.config = (function() {
      ...
      if (t) {
        for (const n in e)
          if (l.call(e, n)) {
            const r = t.getAttribute("data-" + o(n));
            c(r) && (e[n] = "" === r || r);
          }
      ...
      h(a, "init"),
      (i = (r = a).config),
      (e = "history" === (i.routerMode || "hash") && g ? new Le(i) : new $e(i)),
      (r.router = e),
      Re(r),
      (Te = r.route),
      ...
      Pe(a),
      (function(t) {
        const e = t.config.loadSidebar;
        if (t.rendered) {
          const n = se(t.router, ".sidebar-nav", !0, !0);
    ...
    (He.route = {}),
    ((Ne = He)._renderTo = function(e, t, n) {
      const r = v(e);
    ...
    (Ne._renderSidebar = function(e) {
      ...
      const a = se(this.router, ".sidebar-nav", !0, !0);
      i && a
    ...
    (Ne._bindEventOnRendered = function(e) {
      ...
      i &&
        (void 0 === (t = i) && (t = 0),
        (be.scrollTop = !0 === t ? 0 : Number(t)));
    }),
    (Ne._renderNav = function(e) {
      e && this._renderTo("nav", this.compiler.compile(e)),
        this.config.loadNavbar && se(this.router, "nav");
    }),
    (Ne._renderMain = function(r, i, a) {
      const o = this;
      if ((void 0 === i && (i = {}), !r)) return _e.call(this, r);
      h(this, "beforeEach", r, function(e) {
        ...
        o.isHTML
          ? ((t = o.result = r), n(), a())
          : ke({ compiler: o.compiler, raw: e }, function(e) {
    ...
    (Ne._renderCover = function(e, t) {
      ...
      if (($(v("main"), t ? "add" : "remove", "hidden"), e)) {
        $(n, "add", "show");
        let r = this.coverIsHTML ? e : this.compiler.cover(e),
          i = r
            .trim()
            .match(
        ...
        if (i) {
          if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
            ...
            let a = i[1];
            $(n, "add", "has-mask"),
              X(i[1]) || (a = K(this.router.getBasePath(), i[1])),
        ...
        this._renderTo(".cover-main", r), oe();
      } else $(n, "remove", "show");
    }),
    (Ne._updateRender = function() {
      !(function(e) {
        const t = v(".app-name-link"),
          n = e.config.nameLink,
          r = e.route.path;
        if (t)
    ...
    (qe = function(e, t, n) {
      return Me && Me.abort && Me.abort(), (Me = F(e, !0, n));
    }),
    ((ze = He)._loadSideAndNav = function(e, t, n, r) {
      const i = this;
      return function() {
        if (!n) return r();
        Oe(
    ...
    (ze._fetchFallbackPage = function(n, r, i) {
      const a = this;
      void 0 === i && (i = p);
      const e = this.config,
        t = e.requestHeaders,
      ...
      const c = n.replace(new RegExp("^/" + l), "");
      return (
        qe(c + r, 0, t).then(
          function(e, t) {
    ...
    (ze._fetch404 = function(e, t, n) {
      ...
      if (s) {
        ...
        return (
          qe(this.router.getFile(c), 0, o).then(
            function(e, t) {
    ...
    (He.$resetEvents = function() {
      ve(this.route.path, this.route.query.id),
        this.config.loadNavbar && se(this.router, "nav");
    }),
    (window.Docsify = {
      util: Fe,
